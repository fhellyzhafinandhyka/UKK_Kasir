...
class ManagerHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor:
            Color(0xFFEDE4D5), // Same as background color for seamless look
        ...
        child: Column(
          children: [
            ...
            AdminButton(
              label: 'Menu List',
              imageAsset:
                  'lib/assets/burger.png', // Replace with burger image path
              onPressed: () {
            ...
            AdminButton(
              label: 'Table List',
              imageAsset:
                  'lib/assets/add table.png', // Replace with user icon path
              onPressed: () {
                Navigator.push(context,
            ...
            AdminButton(
              ...
              imageAsset:
                  'lib/assets/transaksi.png', // Replace with table icon path
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => TransactionManagerPage()));
              },
            ),
          ],
        ),
